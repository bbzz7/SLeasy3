(function (global, factory) {
    ...
    var gsap,
        ...
        _getBounds = function _getBounds(element, withoutTransforms) {
            ...
            //父容器旋转修复 parent container rotated hacks
            if (window.$scope && window.$scope.isRotated) {
                var _x = bounds.x;
                var _y = bounds.y;
                var _l = bounds.left;
                var _t = bounds.top;
                var _r = bounds.right;
                var _b = bounds.bottom;
                var _w = bounds.width;
                ...
                bounds.x = _y;
                bounds.y = _x;
                // bounds.left = _win.innerHeight - _b;;
                // bounds.top = _l;
				// //
				// bounds.right = _win.innerHeight - _top;
				// bounds.bottom = _left + _w;
            }
            return bounds;
        },
