 ...
 * @author: Jack Doyle, jack@greensock.com
 */
var _gsScope="undefined"!=typeof module&&module.exports&&"undefined"!=typeof global?global:this||window;!function(r){var y=r.GreenSockGlobals||r,D=function(a){var b=a.split("."),d=y;for(a=0;a<b.length;a++)d[b[a]]=d=d[b[a]]||{};return d}("com.greensock.utils"),K=function(a){var b=a.nodeType,d="";if(1===b||9===b||11===b){if("string"==typeof a.textContent)return a.textContent;for(a=a.firstChild;a;a=a.nextSibling)d+=K(a)}else if(3===b||4===b)return a.nodeValue;return d},z=document,R=z.defaultView?z.defaultView.getComputedStyle:function(){},L=/([A-Z])/g,k=function(a,b,d,t){var p;return(d=d||R(a,null))?(a=d.getPropertyValue(b.replace(L,"-$1").toLowerCase()),p=a||d.length?a:d[b]):a.currentStyle&&(d=a.currentStyle,p=d[b]),t?p:parseInt(p,10)||0},G=function(a){return a.length&&a[0]&&(a[0].nodeType&&a[0].style&&!a.nodeType||a[0].length&&a[0][0])?!0:!1},aa=/(?:\r|\n|\s\s|\t\t)/g,S=/(?:<br>|<br\/>|<br \/>)/gi,M=" style='position:relative;display:inline-block;"+(z.all&&!z.addEventListener?"*display:inline;*zoom:1;'":"'"),T=function(a,b){a=a||"";var d=-1!==a.indexOf("++"),t=1;return d&&(a=a.split("++").join("")),function(){return"<"+b+M+(a?" class='"+a+(d?t++:"")+"'>":">")}},A=D.SplitText=y.SplitText=function(a,b){if("string"==typeof a&&(a=A.selector(a)),!a)throw"cannot split a null element.";var d;if(G(a)){d=a;var t,p,k,f=[],w=d.length;for(t=0;w>t;t++)if(p=d[t],G(p))for(k=0;k<p.length;k++)f.push(p[k]);else f.push(p);d=f}else d=[a];this.elements=d;this.chars=[];this.words=[];this.lines=[];this._originals=[];this.vars=b||{};void this.split(b)},U=function(a,b,d){var k=a.nodeType;if(1===k||9===k||11===k)for(a=a.firstChild;a;a=a.nextSibling)U(a,b,d);else 3!==k&&4!==k||(a.nodeValue=a.nodeValue.split(b).join(d))},N=function(a,b){for(var d=b.length;-1<--d;)a.push(b[d])},D=A.prototype;D.split=function(a){this.isSplit&&this.revert();this.vars=a||this.vars;this._originals.length=this.chars.length=this.words.length=this.lines.length=0;for(a=this.elements.length;-1<--a;){this._originals[a]=this.elements[a].innerHTML;var b=this.elements[a],d=this.vars,t=this.chars,p=this.words,r=this.lines;S.test(b.innerHTML)&&(b.innerHTML=b.innerHTML.replace(S,")eefec303079ad17405c"));var f=void 0,w=void 0,g=void 0,m=void 0,e=void 0,h=g=g=void 0,c=void 0,u=void 0,l=void 0,x=void 0,y=void 0,B=void 0,h=K(b),F=d.span?"span":"div",q=d.type||d.split||"chars,words,lines",v=-1!==q.indexOf("lines")?[]:null,C=-1!==q.indexOf("words"),q=-1!==q.indexOf("chars"),n="absolute"===d.position||!0===d.absolute,B=d.wordDelimiter||" ",A=" "!==B?"":n?"&#173; ":" ",D=-999,f=R(b),G=k(b,"paddingLeft",f),L=k(b,"borderBottomWidth",f)+k(b,"borderTopWidth",f),M=k(b,"borderLeftWidth",f)+k(b,"borderRightWidth",f),ba=k(b,"paddingTop",f)+k(b,"paddingBottom",f),ca=k(b,"paddingLeft",f)+k(b,"paddingRight",f),da=k(b,"textAlign",f,!0),ea=.2*k(b,"fontSize"),H=b.clientHeight,I=b.clientWidth,O=d.span?"</span>":"</div>",P=T(d.wordsClass,F),V=T(d.charsClass,F),W=-1!==(d.linesClass||"").indexOf("++"),J=d.linesClass,X=-1!==h.indexOf("<"),E=!0,Q=[],Y=[],Z=[];0!=!d.reduceWhiteSpace&&(h=h.replace(aa,""));W&&(J=J.split("++").join(""));X&&(h=h.split("<").join("{{LT}}"));f=h.length;m=P();for(e=0;f>e;e++)if(g=h.charAt(e),")"===g&&")eefec303079ad17405c"===h.substr(e,20))m+=(E?O:"")+"<BR/>",E=!1,e!==f-20&&")eefec303079ad17405c"!==h.substr(e+20,20)&&(m+=" "+P(),E=!0),e+=19;else if(g===B&&h.charAt(e-1)!==B&&e!==f-1&&")eefec303079ad17405c"!==h.substr(e-20,20)){m+=E?O:"";for(E=!1;h.charAt(e+1)===B;)m+=A,e++;(")"!==h.charAt(e+1)||")eefec303079ad17405c"!==h.substr(e+1,20))&&(m+=A+P(),E=!0)}else"{"===g&&"{{LT}}"===h.substr(e,6)?(m+=q?V()+"{{LT}}</"+F+">":"{{LT}}",e+=5):m+=q&&" "!==g?V()+g+"</"+F+">":g;b.innerHTML=m+(E?O:"");X&&U(b,"{{LT}}","<");g=b.getElementsByTagName("*");f=g.length;h=[];for(e=0;f>e;e++)h[e]=g[e];if(v||n)for(e=0;f>e;e++)c=h[e],((g=c.parentNode===b)||n||q&&!C)&&(u=c.offsetTop,v&&g&&Math.abs(u-D)>ea&&"BR"!==c.nodeName&&(w=[],v.push(w),D=u),n&&(c._x=c.offsetLeft,c._y=u,c._w=c.offsetWidth,c._h=c.offsetHeight),v&&(C!==g&&q||(w.push(c),c._x-=G),g&&e&&(h[e-1]._wordEnd=!0),"BR"===c.nodeName&&c.nextSibling&&"BR"===c.nextSibling.nodeName&&v.push([])));for(e=0;f>e;e++)c=h[e],g=c.parentNode===b,"BR"!==c.nodeName?(n&&(x=c.style,C||g||(c._x+=c.parentNode._x,c._y+=c.parentNode._y),x.left=c._x+"px",x.top=c._y+"px",x.position="absolute",x.display="block",x.width=c._w+1+"px",x.height=c._h+"px"),C?g&&""!==c.innerHTML?Y.push(c):q&&Q.push(c):g?(b.removeChild(c),h.splice(e--,1),f--):!g&&q&&(u=!v&&!n&&c.nextSibling,b.appendChild(c),u||b.appendChild(z.createTextNode(" ")),Q.push(c))):v||n?(b.removeChild(c),h.splice(e--,1),f--):C||b.appendChild(c);if(v){n&&(l=z.createElement(F),b.appendChild(l),y=l.offsetWidth+"px",u=l.offsetParent===b?0:b.offsetLeft,b.removeChild(l));x=b.style.cssText;for(b.style.cssText="display:none;";b.firstChild;)b.removeChild(b.firstChild);B=" "===B&&(!n||!C&&!q);for(e=0;e<v.length;e++){w=v[e];l=z.createElement(F);l.style.cssText="display:block;text-align:"+da+";position:"+(n?"absolute;":"relative;");J&&(l.className=J+(W?e+1:""));Z.push(l);f=w.length;for(g=0;f>g;g++)"BR"!==w[g].nodeName&&(c=w[g],l.appendChild(c),B&&(c._wordEnd||C)&&l.appendChild(z.createTextNode(" ")),n&&(0===g&&(l.style.top=c._y+"px",l.style.left=G+u+"px"),c.style.top="0px",u&&(c.style.left=c._x-u+"px")));0===f&&(l.innerHTML="&nbsp;");C||q||(l.innerHTML=K(l).split(String.fromCharCode(160)).join(" "));n&&(l.style.width=y,l.style.height=c._h+"px");b.appendChild(l)}b.style.cssText=x}n&&(H>b.clientHeight&&(b.style.height=H-ba+"px",b.clientHeight<H&&(b.style.height=H+L+"px")),I>b.clientWidth&&(b.style.width=I-ca+"px",b.clientWidth<I&&(b.style.width=I+M+"px")));N(t,Q);N(p,Y);N(r,Z)}return this.chars.reverse(),this.words.reverse(),this.lines.reverse(),this.isSplit=!0,this};D.revert=function(){if(!this._originals)throw"revert() call wasn't scoped properly.";for(var a=this._originals.length;-1<--a;)this.elements[a].innerHTML=this._originals[a];return this.chars=[],this.words=[],this.lines=[],this.isSplit=!1,this};A.selector=r.$||r.jQuery||function(a){var b=r.$||r.jQuery;return b?(A.selector=b,b(a)):"undefined"==typeof document?a:document.querySelectorAll?document.querySelectorAll(a):document.getElementById("#"===a.charAt(0)?a.substr(1):a)};A.version="0.4.0"}(_gsScope);(function(r){var y=function(){return(_gsScope.GreenSockGlobals||_gsScope)[r]};"function"==typeof define&&define.amd?define([],y):"undefined"!=typeof module&&module.exports&&(module.exports=y())})("SplitText");
 ...
 * @author: Jack Doyle, jack@greensock.com
 */
var _gsScope="undefined"!=typeof module&&module.exports&&"undefined"!=typeof global?global:this||window;(_gsScope._gsQueue||(_gsScope._gsQueue=[])).push(function(){function k(a,b,c,d,g,f){return c=(parseFloat(c)-parseFloat(a))*g,d=(parseFloat(d)-parseFloat(b))*f,Math.sqrt(c*c+d*d)}function h(a){return"string"!=typeof a&&a.nodeType||(a=_gsScope.TweenLite.selector(a),a.length&&(a=a[0])),a}function l(a){if(!a)return 0;a=h(a);var b,c,d,g;c=a.tagName.toLowerCase();var f=1,e=1;if("non-scaling-stroke"===a.getAttribute("vector-effect")&&(e=a.getScreenCTM(),f=e.a,e=e.d),"path"===c){c=a.style.strokeDasharray;a.style.strokeDasharray="none";b=a.getTotalLength()||0;f!==e&&console.log("Warning: <path> length cannot be measured accurately when vector-effect is non-scaling-stroke and the element isn't proportionally scaled.");b*=(f+e)/2;try{a.getBBox()}catch(r){}a.style.strokeDasharray=c}else if("rect"===c)b=2*a.getAttribute("width")*f+2*a.getAttribute("height")*e;else if("line"===c)b=k(a.getAttribute("x1"),a.getAttribute("y1"),a.getAttribute("x2"),a.getAttribute("y2"),f,e);else if("polyline"===c||"polygon"===c)for(a=a.getAttribute("points").match(p)||[],"polygon"===c&&a.push(a[0],a[1]),b=0,c=2;c<a.length;c+=2)b+=k(a[c-2],a[c-1],a[c],a[c+1],f,e)||0;else("circle"===c||"ellipse"===c)&&(d=parseFloat(a.getAttribute("circle"===c?"r":"rx"))*f,g=parseFloat(a.getAttribute("circle"===c?"r":"ry"))*e,b=Math.PI*(3*(d+g)-Math.sqrt((3*d+g)*(d+3*g))));return b||0}function n(a,b){if(!a)return[0,0];a=h(a);b=b||l(a)+1;var c=q(a),d=c.strokeDasharray||"",c=parseFloat(c.strokeDashoffset),g=d.indexOf(",");return 0>g&&(g=d.indexOf(" ")),d=0>g?b:parseFloat(d.substr(0,g))||1E-5,d>b&&(d=b),[Math.max(0,-c),Math.max(0,d-c)]}var m,q=document.defaultView?document.defaultView.getComputedStyle:function(){},p=/(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi;m=_gsScope._gsDefine.plugin({propName:"drawSVG",API:2,version:"0.1.1",global:!0,overwriteProps:["drawSVG"],init:function(a,b,c,d){if(!a.getBBox)return!1;var g;c=l(a)+1;this._style=a.style;"function"==typeof b&&(b=b(d,a));!0===b||"true"===b?b="0 100%":b?-1===(b+"").indexOf(" ")&&(b="0 "+b):b="0 0";a=n(a,c);d=a[0];var f,e,h=b.indexOf(" ");b=(-1===h?(f=void 0!==d?d+"":b,e=b):(f=b.substr(0,h),e=b.substr(h+1)),f=-1!==f.indexOf("%")?parseFloat(f)/100*c:parseFloat(f),e=-1!==e.indexOf("%")?parseFloat(e)/100*c:parseFloat(e),f>e?[e,f]:[f,e]);return this._length=c+10,0===a[0]&&0===b[0]?(g=Math.max(1E-5,b[1]-c),this._dash=c+g,this._offset=c-a[1]+g,this._addTween(this,"_offset",this._offset,c-b[1]+g,"drawSVG")):(this._dash=a[1]-a[0]||1E-6,this._offset=-a[0],this._addTween(this,"_dash",this._dash,b[1]-b[0]||1E-5,"drawSVG"),this._addTween(this,"_offset",this._offset,-b[0],"drawSVG")),!0},set:function(a){this._firstPT&&(this._super.setRatio.call(this,a),this._style.strokeDashoffset=this._offset,1===a||0===a?this._style.strokeDasharray=.001>this._offset&&10>=this._length-this._dash?"none":this._offset===this._dash?"0px, 999999px":this._dash+"px,"+this._length+"px":this._style.strokeDasharray=this._dash+"px,"+this._length+"px")}});m.getLength=l;m.getPosition=n});_gsScope._gsDefine&&_gsScope._gsQueue.pop()();(function(k){var h=function(){return(_gsScope.GreenSockGlobals||_gsScope)[k]};"function"==typeof define&&define.amd?define(["TweenLite"],h):"undefined"!=typeof module&&module.exports&&(require("../TweenLite.js"),module.exports=h())})("DrawSVGPlugin");
 ...
 * @author: Jack Doyle, jack@greensock.com
 */
var _gsScope="undefined"!=typeof module&&module.exports&&"undefined"!=typeof global?global:this||window;(_gsScope._gsQueue||(_gsScope._gsQueue=[])).push(function(){var G=Math.PI/180,M=180/Math.PI,V=/[achlmqstvz]|(-?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,F=/(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,W=/[achlmqstvz]/gi,X=/\d+e[\-\+]\d+/gi,H=_gsScope._gsDefine.globals.TweenLite,x=function(c){window.console&&console.log(c)},Y=function(c,f,e,a,d,b,h,g,q){if(c!==g||f!==q){e=Math.abs(e);a=Math.abs(a);var t=d%360*G;d=Math.cos(t);var t=Math.sin(t),n=(c-g)/2,p=(f-q)/2,k=d*n+t*p,n=-t*n+d*p,p=e*e,r=a*a,u=k*k,l=n*n,v=u/p+l/r;1<v&&(e*=Math.sqrt(v),a*=Math.sqrt(v),p=e*e,r=a*a);p=(p*r-p*l-r*u)/(p*l+r*u);0>p&&(p=0);b=(b===h?-1:1)*Math.sqrt(p);r=e*n/a*b;u=b*-(a*k/e);c=(c+g)/2+(d*r-t*u);f=(f+q)/2+(t*r+d*u);b=(k-r)/e;p=(n-u)/a;k=(-k-r)/e;r=(-n-u)/a;u=Math.sqrt(b*b+p*p);n=(0>p?-1:1)*Math.acos(b/u)*M;u=Math.sqrt((b*b+p*p)*(k*k+r*r));b=(0>b*r-p*k?-1:1)*Math.acos((b*k+p*r)/u)*M;!h&&0<b?b-=360:h&&0>b&&(b+=360);var k=n%360,p=b%360,m,n=Math.ceil(Math.abs(p)/90);b=0;h=[];k*=G;p*=G;p/=n;r=4/3*Math.sin(p/2)/(1+Math.cos(p/2));for(m=0;n>m;m++)u=k+m*p,l=Math.cos(u),v=Math.sin(u),h[b++]=l-r*v,h[b++]=v+r*l,u+=p,l=Math.cos(u),v=Math.sin(u),h[b++]=l+r*v,h[b++]=v-r*l,h[b++]=l,h[b++]=v;k=d*e;e*=t;t*=-a;b=d*a;p=h.length-2;for(a=0;p>a;a+=2)d=h[a],n=h[a+1],h[a]=d*k+n*t+c,h[a+1]=d*e+n*b+f;return h[h.length-2]=g,h[h.length-1]=q,h}},D=function(c){var f,e,a,d,b,h,g,q,t,n,p,k,r=(c+"").replace(X,function(a){var b=+a;return 1E-4>b&&-1E-4<b?0:a}).match(V)||[],u=[],l=k=0,v=r.length,m=2,w=0;if(!c||!isNaN(r[0])||isNaN(r[1]))return x("ERROR: malformed path data: "+c),u;for(f=0;v>f;f++)if(e=b,isNaN(r[f])?(b=r[f].toUpperCase(),h=b!==r[f]):f--,a=+r[f+1],d=+r[f+2],h&&(a+=k,d+=l),0===f&&(q=a,t=d),"M"===b)g&&8>g.length&&(--u.length,m=0),k=q=a,l=t=d,g=[a,d],w+=m,m=2,u.push(g),f+=2,b="L";else if("C"===b)g||(g=[0,0]),g[m++]=a,g[m++]=d,h||(k=l=0),g[m++]=k+1*r[f+3],g[m++]=l+1*r[f+4],g[m++]=k+=1*r[f+5],g[m++]=l+=1*r[f+6],f+=6;else if("S"===b)"C"===e||"S"===e?(n=k-g[m-4],p=l-g[m-3],g[m++]=k+n,g[m++]=l+p):(g[m++]=k,g[m++]=l),g[m++]=a,g[m++]=d,h||(k=l=0),g[m++]=k+=1*r[f+3],g[m++]=l+=1*r[f+4],f+=4;else if("Q"===b)n=a-k,p=d-l,g[m++]=k+2*n/3,g[m++]=l+2*p/3,h||(k=l=0),k+=1*r[f+3],l+=1*r[f+4],n=a-k,p=d-l,g[m++]=k+2*n/3,g[m++]=l+2*p/3,g[m++]=k,g[m++]=l,f+=4;else if("T"===b)n=k-g[m-4],p=l-g[m-3],g[m++]=k+n,g[m++]=l+p,n=k+1.5*n-a,p=l+1.5*p-d,g[m++]=a+2*n/3,g[m++]=d+2*p/3,g[m++]=k=a,g[m++]=l=d,f+=2;else if("H"===b)d=l,g[m++]=k+(a-k)/3,g[m++]=l+(d-l)/3,g[m++]=k+2*(a-k)/3,g[m++]=l+2*(d-l)/3,g[m++]=k=a,g[m++]=d,f+=1;else if("V"===b)d=a,a=k,h&&(d+=l-k),g[m++]=a,g[m++]=l+(d-l)/3,g[m++]=a,g[m++]=l+2*(d-l)/3,g[m++]=a,g[m++]=l=d,f+=1;else if("L"===b||"Z"===b)"Z"===b&&(a=q,d=t,g.closed=!0),("L"===b||.5<Math.abs(k-a)||.5<Math.abs(l-d))&&(g[m++]=k+(a-k)/3,g[m++]=l+(d-l)/3,g[m++]=k+2*(a-k)/3,g[m++]=l+2*(d-l)/3,g[m++]=a,g[m++]=d,"L"===b&&(f+=2)),k=a,l=d;else if("A"===b){k=Y(k,l,1*r[f+1],1*r[f+2],1*r[f+3],1*r[f+4],1*r[f+5],(h?k:0)+1*r[f+6],(h?l:0)+1*r[f+7]);for(e=0;e<k.length;e++)g[m++]=k[e];k=g[m-2];l=g[m-1];f+=7}else x("Error: malformed path data: "+c);return u.totalPoints=w+m,u},E=function(c,f){var e,a,d,b,h,g,q,t,n,p,k,r,u,l,v=0,m=c.length,w=f/((m-2)/6);for(u=2;m>u;u+=6)for(v+=w;.999999<v;)e=c[u-2],a=c[u-1],d=c[u],b=c[u+1],h=c[u+2],g=c[u+3],q=c[u+4],t=c[u+5],l=1/(Math.floor(v)+1),n=e+(d-e)*l,k=d+(h-d)*l,n+=(k-n)*l,k+=(h+(q-h)*l-k)*l,p=a+(b-a)*l,r=b+(g-b)*l,p+=(r-p)*l,r+=(g+(t-g)*l-r)*l,c.splice(u,4,e+(d-e)*l,a+(b-a)*l,n,p,n+(k-n)*l,p+(r-p)*l,k,r,h+(q-h)*l,g+(t-g)*l),u+=6,m+=6,v--;return c},N=function(c){var f,e,a,d,b="",h=c.length;for(e=0;h>e;e++){d=c[e];b+="M"+d[0]+","+d[1]+" C";f=d.length;for(a=2;f>a;a++)b+=(100*d[a++]|0)/100+","+(100*d[a++]|0)/100+" "+(100*d[a++]|0)/100+","+(100*d[a++]|0)/100+" "+(100*d[a++]|0)/100+","+(100*d[a]|0)/100+" ";d.closed&&(b+="z")}return b},B=function(c){for(var f=[],e=c.length-1,a=0;-1<--e;)f[a++]=c[e],f[a++]=c[e+1],e--;for(e=0;a>e;e++)c[e]=f[e];c.reversed=c.reversed?!1:!0},O=function(c){var f,e=c.length,a=0,d=0;for(f=0;e>f;f++)a+=c[f++],d+=c[f];return[a/(e/2),d/(e/2)]},C=function(c){var f,e,a,d=c.length,b=c[0],h=b,g=c[1],q=g;for(a=6;d>a;a+=6)f=c[a],e=c[a+1],f>b?b=f:h>f&&(h=f),e>g?g=e:q>e&&(q=e);return c.centerX=(b+h)/2,c.centerY=(g+q)/2,c.size=(b-h)*(g-q)},P=function(c){for(var f,e,a,d,b,h=c.length,g=c[0][0],q=g,t=c[0][1],n=t;-1<--h;)for(b=c[h],f=b.length,d=6;f>d;d+=6)e=b[d],a=b[d+1],e>g?g=e:q>e&&(q=e),a>t?t=a:n>a&&(n=a);return c.centerX=(g+q)/2,c.centerY=(t+n)/2,c.size=(g-q)*(t-n)},Z=function(c,f){return f.length-c.length},Q=function(c,f){var e=c.size||C(c),a=f.size||C(f);return Math.abs(a-e)<(e+a)/20?f.centerX-c.centerX||f.centerY-c.centerY:a-e},R=function(c,f){var e,a,d=c.slice(0),b=c.length,h=b-2;f|=0;for(e=0;b>e;e++)a=(e+f)%h,c[e++]=d[a],c[e]=d[a+1]},I=function(c,f,e,a,d){var b,h,g,q=c.length,t=0,n=q-2;e*=6;for(h=0;q>h;h+=6)b=(h+e)%n,g=c[b]-(f[h]-a),b=c[b+1]-(f[h+1]-d),t+=Math.sqrt(b*b+g*g);return t},aa=function(c,f,e,a,d,b){var h,g,q=f.length,t=0;a*=Math.min(c.size||C(c),f[e].size||C(f[e]));var n=999999999999;d=c.centerX+d;for(c=c.centerY+b;q>e&&(h=f[e].size||C(f[e]),!(a>h));e++)g=f[e].centerX-d,b=f[e].centerY-c,g=Math.sqrt(g*g+b*b),n>g&&(t=e,n=g);return g=f[t],f.splice(t,1),g},S=function(c,f,e,a){var d,b,h,g,q=f.length-c.length;d=0<q?f:c;b=0<q?c:f;var t=0,n="complexity"===a?Z:Q,p="position"===a?0:"number"==typeof a?a:.8;a=b.length;var k="object"==typeof e&&e.push?e.slice(0):[e],r="reverse"===k[0]||0>k[0],u="log"===e;if(b[0]){if(1<d.length&&(c.sort(n),f.sort(n),h=d.size||P(d),h=b.size||P(b),h=d.centerX-b.centerX,g=d.centerY-b.centerY,n===Q))for(a=0;a<b.length;a++)d.splice(a,0,aa(b[a],d,a,p,h,g));if(q)for(0>q&&(q=-q),d[0].length>b[0].length&&E(b[0],(d[0].length-b[0].length)/6|0),a=b.length;q>t;){d[a].size||C(d[a]);var l=e=void 0,v=void 0;g=h=l=void 0;for(var n=b.length,p=99999999999,m=0,w=0;-1<--n;)for(e=b[n],g=e.length,h=0;g>h;h+=6)l=e[h]-d[a].centerX,v=e[h+1]-d[a].centerY,l=Math.sqrt(l*l+v*v),p>l&&(p=l,m=e[h],w=e[h+1]);h=[m,w];e=h[0];h=h[1];b[a++]=[e,h,e,h,e,h,e,h];b.totalPoints+=8;t++}for(a=0;a<c.length;a++)if(d=f[a],b=c[a],q=d.length-b.length,0>q?E(d,-q/6|0):0<q&&E(b,q/6|0),r&&!b.reversed&&B(b),e=k[a]||0===k[a]?k[a]:"auto"){if(b.closed||.5>Math.abs(b[0]-b[b.length-2])&&.5>Math.abs(b[1]-b[b.length-1]))if("auto"===e||"log"===e){q=a;t=b;e=d;h=0===a;w=m=p=void 0;g=t.length;for(var p=O(t),m=O(e),n=m[0]-p[0],l=m[1]-p[1],v=I(t,e,0,n,l),z=0,w=6;g>w;w+=6)m=I(t,e,w/6,n,l),v>m&&(v=m,z=w);if(h)for(p=t.slice(0),B(p),w=6;g>w;w+=6)m=I(p,e,w/6,n,l),v>m&&(v=m,z=-w);k[q]=e=z/6;0>e&&(r=!0,B(b),e=-e);R(b,6*e)}else"reverse"!==e&&(a&&0>e&&B(b),R(b,6*(0>e?-e:e)));else!r&&("auto"===e&&Math.abs(d[0]-b[0])+Math.abs(d[1]-b[1])+Math.abs(d[d.length-2]-b[b.length-2])+Math.abs(d[d.length-1]-b[b.length-1])>Math.abs(d[0]-b[b.length-2])+Math.abs(d[1]-b[b.length-1])+Math.abs(d[d.length-2]-b[0])+Math.abs(d[d.length-1]-b[1])||e%2)?(B(b),k[a]=-1,r=!0):"auto"===e?k[a]=0:"reverse"===e&&(k[a]=-1);b.closed!==d.closed&&(b.closed=d.closed=!1)}return u&&x("shapeIndex:["+k.join(",")+"]"),k}},J=function(c,f,e,a){var d=D(c[0]),b=D(c[1]);S(d,b,f||0===f?f:"auto",e)&&(c[0]=N(d),c[1]=N(b),("log"===a||!0===a)&&x('precompile:["'+c[0]+'","'+c[1]+'"]'))},ba=function(c,f,e){return f||e||c||0===c?function(a){J(a,c,f,e)}:J},T=function(c,f){var e,a,d,b,h,g,q,t=0,n=parseFloat(c[0]),p=parseFloat(c[1]),k=n+","+p+" ";d=c.length;e=.5*f/(.5*d-1);for(a=0;d-2>a;a+=2){if(t+=e,g=parseFloat(c[a+2]),q=parseFloat(c[a+3]),.999999<t)for(h=1/(Math.floor(t)+1),b=1;.999999<t;)k+=(n+(g-n)*h*b).toFixed(2)+","+(p+(q-p)*h*b).toFixed(2)+" ",t--,b++;k+=g+","+q+" ";n=g;p=q}return k},K=function(c){var f=c[0].match(F)||[],e=c[1].match(F)||[],a=e.length-f.length;0<a?c[0]=T(f,a):c[1]=T(e,-a)},ca=function(c){return isNaN(c)?K:function(f){K(f);var e;var a=f[1],d=parseInt(c,10);if(d){var b,a=a.match(F)||[],h=a.length,g="";"reverse"===d?(b=h-1,e=-2):(b=(2*(parseInt(d,10)||0)+1+100*h)%h,e=2);for(d=0;h>d;d+=2)g+=a[b-1]+","+a[b]+" ",b=(b+e)%h;e=g}else e=a;f[1]=e}},U=function(c,f){var e,a,d,b,h,g,q,t,n,p,k,r,u,l,v,m,w,z,y,x,A=c.tagName.toLowerCase();if("path"!==A&&c.getBBox){for(var C="x,y,width,height,cx,cy,rx,ry,r,x1,x2,y1,y2,points",B=document.createElementNS("http://www.w3.org/2000/svg","path"),D=Array.prototype.slice.call(c.attributes),E=D.length,C=","+C+",";-1<--E;)-1===C.indexOf(","+D[E].nodeName+",")&&B.setAttributeNS(null,D[E].nodeName,D[E].nodeValue);A=("rect"===A?(b=+c.getAttribute("rx")||0,h=+c.getAttribute("ry")||0,a=+c.getAttribute("x")||0,d=+c.getAttribute("y")||0,n=(+c.getAttribute("width")||0)-2*b,p=(+c.getAttribute("height")||0)-2*h,b||h?(k=a+b*(1-.552284749831),r=a+b,u=r+n,l=u+.552284749831*b,v=u+b,m=d+h*(1-.552284749831),w=d+h,z=w+p,y=z+.552284749831*h,x=z+h,e="M"+v+","+w+" V"+z+" C"+[v,y,l,x,u,x,u-(u-r)/3,x,r+(u-r)/3,x,r,x,k,x,a,y,a,z,a,z-(z-w)/3,a,w+(z-w)/3,a,w,a,m,k,d,r,d,r+(u-r)/3,d,u-(u-r)/3,d,u,d,l,d,v,m,v,w].join()+"z"):e="M"+(a+n)+","+d+" v"+p+" h"+-n+" v"+-p+" h"+n+"z"):"circle"===A||"ellipse"===A?("circle"===A?(b=h=+c.getAttribute("r")||0,q=.552284749831*b):(b=+c.getAttribute("rx")||0,h=+c.getAttribute("ry")||0,q=.552284749831*h),a=+c.getAttribute("cx")||0,d=+c.getAttribute("cy")||0,g=.552284749831*b,e="M"+(a+b)+","+d+" C"+[a+b,d+q,a+g,d+h,a,d+h,a-g,d+h,a-b,d+q,a-b,d,a-b,d-q,a-g,d-h,a,d-h,a+g,d-h,a+b,d-q,a+b,d].join()+"z"):"line"===A?e="M"+c.getAttribute("x1")+","+c.getAttribute("y1")+" L"+c.getAttribute("x2")+","+c.getAttribute("y2"):("polyline"===A||"polygon"===A)&&(t=(c.getAttribute("points")+"").match(F)||[],a=t.shift(),d=t.shift(),e="M"+a+","+d+" L"+t.join(","),"polygon"===A&&(e+=","+a+","+d+"z")),B.setAttribute("d",e),f&&c.parentNode&&(c.parentNode.insertBefore(B,c),c.parentNode.removeChild(c)),B)}else A=c;return A},L=function(c,f,e){var a,d,b="string"==typeof c;return(!b||3>(c.match(F)||[]).length)&&(a=b?H.selector(c):c&&c[0]?c:[c],a&&a[0]?(a=a[0],d=a.nodeName.toUpperCase(),f&&"PATH"!==d&&(a=U(a,!1),d="PATH"),c=a.getAttribute("PATH"===d?"d":"points")||"",a===e&&(c=a.getAttributeNS(null,"data-original")||c)):(x("WARNING: invalid morph to: "+c),c=!1)),c},y=_gsScope._gsDefine.plugin({propName:"morphSVG",API:2,global:!0,version:"0.8.4",init:function(c,f,e){var a,d,b,h,g;return"function"!=typeof c.setAttribute?!1:(a=c.nodeName.toUpperCase(),g="POLYLINE"===a||"POLYGON"===a,"PATH"===a||g?(d="PATH"===a?"d":"points",("string"==typeof f||f.getBBox||f[0])&&(f={shape:f}),h=L(f.shape||f.d||f.points||"","d"===d,c),g&&W.test(h)?(x("WARNING: a <"+a+"> cannot accept path data. Use MorphSVGPlugin.convertToPath(elementOrSelectorText) to convert to a path before morphing."),!1):(h&&(this._target=c,c.getAttributeNS(null,"data-original")||c.setAttributeNS(null,"data-original",c.getAttribute(d)),b=this._addTween(c,"setAttribute",c.getAttribute(d)+"",h+"","morphSVG",!1,d,"object"==typeof f.precompile?function(a){a[0]=f.precompile[0];a[1]=f.precompile[1]}:"d"===d?ba(f.shapeIndex,f.map||y.defaultMap,f.precompile):ca(f.shapeIndex)),b&&(this._overwriteProps.push("morphSVG"),b.end=h,b.endProp=d)),!0)):(x("WARNING: cannot morph a <"+a+"> SVG element. Use MorphSVGPlugin.convertToPath(elementOrSelectorText) to convert to a path before morphing."),!1))},set:function(c){if(this._super.setRatio.call(this,c),1===c)for(c=this._firstPT;c;)c.end&&this._target.setAttribute(c.endProp,c.end),c=c._next}});y.pathFilter=J;y.pointsFilter=K;y.subdivideRawBezier=E;y.defaultMap="size";y.pathDataToRawBezier=function(c){return D(L(c,!0))};y.equalizeSegmentQuantity=S;y.convertToPath=function(c,f){"string"==typeof c&&(c=H.selector(c));for(var e=c&&0!==c.length?c.length&&c[0]&&c[0].nodeType?Array.prototype.slice.call(c,0):[c]:[],a=e.length;-1<--a;)e[a]=U(e[a],!1!==f);return e};y.pathDataToBezier=function(c,f){var e,a,d,b,h,g,q,t=D(L(c,!0))[0]||[],n=0;if(f=f||{},q=f.align||f.relative,b=f.matrix||[1,0,0,1,0,0],h=f.offsetX||0,g=f.offsetY||0,"relative"===q||!0===q?(h-=t[0]*b[0]+t[1]*b[2],g-=t[0]*b[1]+t[1]*b[3],n="+="):(h+=b[4],g+=b[5],q&&(q="string"==typeof q?H.selector(q):q&&q[0]?q:[q],q&&q[0]&&(a=q[0].getBBox()||{x:0,y:0},h-=a.x,g-=a.y))),e=[],d=t.length,b)for(a=0;d>a;a+=2)e.push({x:n+(t[a]*b[0]+t[a+1]*b[2]+h),y:n+(t[a]*b[1]+t[a+1]*b[3]+g)});else for(a=0;d>a;a+=2)e.push({x:n+(t[a]+h),y:n+(t[a+1]+g)});return e}});_gsScope._gsDefine&&_gsScope._gsQueue.pop()();
 ...
 * @author: Jack Doyle, jack@greensock.com
 */
var _gsScope="undefined"!=typeof module&&module.exports&&"undefined"!=typeof global?global:this||window;(_gsScope._gsQueue||(_gsScope._gsQueue=[])).push(function(){_gsScope._gsDefine("easing.CustomEase",["easing.Ease"],function(w){var x=/(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,F=/[achlmqstvz]|(-?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,G=/[\+\-]?\d*\.?\d+e[\+\-]?\d+/gi,H=/[cLlsS]/g,A=function(c,a,b,g,l,e,q,d,f,m,r){var n,u=(c+b)/2,h=(a+g)/2,k=(b+l)/2,t=(g+e)/2,p=(l+q)/2,v=(e+d)/2,w=(u+k)/2,x=(h+t)/2,k=(k+p)/2,t=(t+v)/2,B=(w+k)/2,C=(x+t)/2,y=q-c,z=d-a;b=Math.abs((b-q)*z-(g-d)*y);l=Math.abs((l-q)*z-(e-d)*y);return m||(m=[{x:c,y:a},{x:q,y:d}],r=1),m.splice(r||m.length-1,0,{x:B,y:C}),(b+l)*(b+l)>f*(y*y+z*z)&&(n=m.length,A(c,a,u,h,w,x,B,C,f,m,r),A(B,C,k,t,p,v,q,d,f,m,r+1+(m.length-n))),m},I=function(c){var a,b,g,l,e,q,d,f,m,r,n=(c+"").replace(G,function(a){a=+a;return 1E-4>a&&-1E-4<a?0:a}).match(F)||[],u=[],h=0,k=0,t=n.length,p=2;for(c=0;t>c;c++)if(f=g,isNaN(n[c])?(g=n[c].toUpperCase(),l=g!==n[c]):c--,a=+n[c+1],b=+n[c+2],l&&(a+=h,b+=k),c||(q=a,d=b),"M"===g)e&&8>e.length&&(--u.length,p=0),h=q=a,k=d=b,e=[a,b],p=2,u.push(e),c+=2,g="L";else if("C"===g)e||(e=[0,0]),e[p++]=a,e[p++]=b,l||(h=k=0),e[p++]=h+1*n[c+3],e[p++]=k+1*n[c+4],e[p++]=h+=1*n[c+5],e[p++]=k+=1*n[c+6],c+=6;else if("S"===g)"C"===f||"S"===f?(m=h-e[p-4],r=k-e[p-3],e[p++]=h+m,e[p++]=k+r):(e[p++]=h,e[p++]=k),e[p++]=a,e[p++]=b,l||(h=k=0),e[p++]=h+=1*n[c+3],e[p++]=k+=1*n[c+4],c+=4;else{if("L"!==g&&"Z"!==g)throw"CustomEase only accepts Cubic Bezier data.";"Z"===g&&(a=q,b=d,e.closed=!0);("L"===g||.5<Math.abs(h-a)||.5<Math.abs(k-b))&&(e[p++]=h+(a-h)/3,e[p++]=k+(b-k)/3,e[p++]=h+2*(a-h)/3,e[p++]=k+2*(b-k)/3,e[p++]=a,e[p++]=b,"L"===g&&(c+=2));h=a;k=b}return u[0]},D=function(c){var a=this.lookup[c*this.l|0]||this.lookup[this.l-1];return a.nx<c&&(a=a.n),a.y+(c-a.x)/a.cx*a.cy},v=function(c,a,b){var g,l,e,q,d,f;d=(a+"").match(x);q=1;var m=[];if(b=b||{},f=b.precision||1,this.data=a,this.lookup=[],this.points=m,this.fast=1>=f,this._calcEnd=!0,this.name=c,(H.test(a)||-1!==a.indexOf("M")&&-1===a.indexOf("C"))&&(d=I(a)),g=d.length,4===g)d.unshift(0,0),d.push(1,1),g=8;else if((g-2)%6)throw"CustomEase only accepts Cubic Bezier data.";if(0!==+d[0]||1!==+d[g-2]){a=d;var r=b.originY;r||0===r||(r=+a[1]);e=-1*+a[0];var r=-r,n=a.length,u=1/(+a[n-2]+e);if(!(b=-b.height))if(Math.abs(+a[n-1]-+a[1])<.01*(+a[n-2]-+a[0])){var h=a.length,k=999999999999;for(b=1;h>b;b+=6)+a[b]<k&&(k=+a[b]);b=k+r}else b=+a[n-1]+r;h=(h=b)?1/h:-u;for(b=0;n>b;b+=2)a[b]=(+a[b]+e)*u,a[b+1]=(+a[b+1]+r)*h}this.rawBezier=d;for(a=2;g>a;a+=6)l={x:+d[a-2],y:+d[a-1]},e={x:+d[a+4],y:+d[a+5]},m.push(l,e),A(l.x,l.y,+d[a],+d[a+1],+d[a+2],+d[a+3],e.x,e.y,1/(2E5*f),m,m.length-1);g=m.length;for(a=0;g>a;a++)f=m[a],d=m[a-1]||f,f.x>d.x||d.y!==f.y&&d.x===f.x||f===d?(d.cx=f.x-d.x,d.cy=f.y-d.y,d.n=f,d.nx=f.x,this.fast&&1<a&&2<Math.abs(d.cy/d.cx-m[a-2].cy/m[a-2].cx)&&(this.fast=!1),d.cx<q&&(d.cx?q=d.cx:d.cx=.001)):(m.splice(a--,1),g--);if(g=1/q+1|0,this.l=g,q=1/g,d=0,f=m[0],this.fast){for(a=0;g>a;a++)e=a*q,f.nx<e&&(f=m[++d]),l=f.y+(e-f.x)/f.cx*f.cy,this.lookup[a]={x:e,cx:q,y:l,cy:0,nx:9},a&&(this.lookup[a-1].cy=l-this.lookup[a-1].y);this.lookup[g-1].cy=m[m.length-1].y-l}else for(a=0;g>a;a++)f.nx<a*q&&(f=m[++d]),this.lookup[a]=f;c&&(w.map[c]=this);this.getRatio=D},E=v.prototype=new w;return E.constructor=v,E.getRatio=D,v.create=function(c,a,b){return new v(c,a,b)},v.version="0.1.0",v.bezierToPoints=A,v.get=function(c){return w.map[c]},v.getSVGData=function(c,a){a=a||{};var b,g,l,e,q,d,f,m,r,n,u=a.width||100,h=a.height||100,k=a.x||0,t=(a.y||0)+h;if(a.invert&&(h=-h,t=0),b=["M"+k+","+t],c=c.getRatio?c:w.map[c],c.rawBezier){f=c.rawBezier.length;for(l=2;f>l;l+=2)b.push((1E3*(k+c.rawBezier[l]*u)|0)/1E3+","+(1E3*(t+c.rawBezier[l+1]*-h)|0)/1E3);b[1]="C"+b[1]}else for(f=Math.max(5,200*(a.precision||1)),e=1/f,f+=2,m=5/f,r=(1E3*(k+e*u)|0)/1E3,n=(1E3*(t+c.getRatio(e)*-h)|0)/1E3,g=(n-t)/(r-k),l=2;f>l;l++)q=(1E3*(k+l*e*u)|0)/1E3,d=(1E3*(t+c.getRatio(l*e)*-h)|0)/1E3,(Math.abs((d-n)/(q-r)-g)>m||l===f-1)&&(b.push(r+","+n),g=(d-n)/(q-r)),r=q,n=d;return b.join(" ")},v},!0)});_gsScope._gsDefine&&_gsScope._gsQueue.pop()();(function(w){var x=function(){return(_gsScope.GreenSockGlobals||_gsScope)[w]};"function"==typeof define&&define.amd?define(["TweenLite"],x):"undefined"!=typeof module&&module.exports&&(require("../TweenLite.js"),module.exports=x())})("CustomEase");
 ...
 * @author: Jack Doyle, jack@greensock.com
 */
var _gsScope="undefined"!=typeof module&&module.exports&&"undefined"!=typeof global?global:this||window;(_gsScope._gsQueue||(_gsScope._gsQueue=[])).push(function(){"use strict";_gsScope._gsDefine("easing.CustomBounce",["easing.CustomEase"],function(a){var d,b=function(a){var e,b=a.length,c=1/a[b-2],d=1e3;for(e=2;b>e;e+=2)a[e]=(a[e]*c*d|0)/d;a[b-2]=1},c=function(c,d){d=d||{};var p,q,r,s,t,u,v,e=.999,f=Math.min(e,d.strength||.7),g=f,h=(d.squash||0)/100,i=h,j=1/.03,k=.2,l=1,m=.1,n=[0,0,.07,0,.1,1,.1,1],o=[0,0,0,0,.1,0,.1,0];for(t=0;200>t&&(k*=g*((g+1)/2),l*=f*f,u=m+k,r=m+.49*k,s=1-l,p=m+l/j,q=r+.8*(r-p),h&&(m+=h,p+=h,r+=h,q+=h,u+=h,v=h/i,o.push(m-h,0,m-h,v,m-h/2,v,m,v,m,0,m,0,m,v*-.6,(u+m+m)/3,0,u,0),n.push(m-h,1,m,1,m,1),h*=f*f),n.push(m,1,p,s,r,s,q,s,u,1,u,1),f*=.95,j=l/(u-q),m=u,!(s>e));t++);h&&(b(o),o[2]="C"+o[2],this.squash=new a(d.squashName||c+"-squash","M"+o.join(","))),b(n),n[2]="C"+n[2],a.call(this,c,"M"+n.join(",")),this.bounce=this};return c.prototype=d=new a("-","0,0,1,1"),d.constructor=c,c.create=function(a,b){return new c(a,b)},c.version="0.0.1",c},!0)}),_gsScope._gsDefine&&_gsScope._gsQueue.pop()(),function(a){"use strict";var b=function(){return(_gsScope.GreenSockGlobals||_gsScope)[a]};"function"==typeof define&&define.amd?define(["TweenLite","CustomEase"],b):"undefined"!=typeof module&&module.exports&&(require("./CustomEase.js"),require("../TweenLite.js"),module.exports=b())}("CustomBounce");